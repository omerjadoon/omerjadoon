...
|  | |
|:---:|:---|
| <img src="https://designshack.net/wp-content/uploads/placeholder-image.png" alt="SanaExpert Logo" width="800"/> | <br> 🤖 **SanaExpert AI Agent** <br>  [🔗 Project Link](#)<br> *Multimodal AI Customer Support* <br> `FastAPI, Agentic AI, Multimodal AI for customer support`. |
| <img src="https://designshack.net/wp-content/uploads/placeholder-image.png" alt="Amidiro Audio Assistant"/> | <br> 📞 **Amidiro Audio Assistant** <br>  [🔗 Project Link](#)<br> *AI Call Center Agent* <br> `Speech models, AI for call center automation`. |
